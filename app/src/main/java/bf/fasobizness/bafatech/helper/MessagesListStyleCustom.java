...
public class MessagesListStyleCustom extends Style {
    ...
    protected MessagesListStyleCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public static MessagesListStyleCustom parse(Context context, AttributeSet attrs) {
        MessagesListStyleCustom style = new MessagesListStyleCustom(context, attrs);
