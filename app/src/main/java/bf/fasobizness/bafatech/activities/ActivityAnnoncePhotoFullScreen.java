...
import bf.fasobizness.bafatech.adapters.AnnoncePhotoFullScreenAdapter;
...
public class ActivityAnnoncePhotoFullScreen extends AppCompatActivity implements OnItemListener {
    private List<Announce.Annonce.Illustration> images;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            images = (ArrayList<Announce.Annonce.Illustration>) intent.getSerializableExtra("images");
            int position = intent.getIntExtra("position", 0);
            AnnoncePhotoFullScreenAdapter imagesAdapter = new AnnoncePhotoFullScreenAdapter(this, images);
    ...
    private void downloadFile() {
        this.downloadUrl = images.get(viewPager.getCurrentItem()).getNom();
    ...
    class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ActivityAnnoncePhotoFullScreen.this);
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    ContextThemeWrapper ctw = new ContextThemeWrapper(ActivityAnnoncePhotoFullScreen.this, R.style.AppTheme);
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    Toast.makeText(ActivityAnnoncePhotoFullScreen.this, "Oops!! SD Card indisponible.", Toast.LENGTH_SHORT).show();
